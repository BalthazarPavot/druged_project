 ...
 * chained_list.h
 * 
 * Copyright 2016 balto <balto@lain>
 * 
...
p_chained_list new_chained_list_init (void *value, size_t size) ;
p_chained_list init_chained_list (p_chained_list chained_list, void *value,
  size_t size) ;
p_chained_list push_chained_list (p_chained_list chained_list, void *value,
  size_t size) ;
p_chained_list pop_chained_list (p_chained_list chained_list, void *value) ;
p_chained_list shift_chained_list (p_chained_list chained_list, void *value,
  size_t size) ;
p_chained_list unshift_chained_list (p_chained_list chained_list, void *value) ;
p_chained_list concatenate_chained_lists (p_chained_list left,
  p_chained_list right) ;
p_chained_list remove_chained_list (p_chained_list chained_list, void *value,
  size_t size) ;
p_chained_list delete_chained_list (p_chained_list chained_list,
  int index) ;
#ifdef _INTERNAL_CHAINED_LIST
static p_chained_list _delete_chained_list (p_chained_list chained_list,
  int index) ;
#endif /* end ifdef _INTERNAL_CHAINED_LIST */
p_chained_list insert_chained_list (p_chained_list chained_list, void *value,
  size_t size, int index) ;
#ifdef _INTERNAL_CHAINED_LIST
static p_chained_list _insert_chained_list (p_chained_list chained_list,
  void *value, size_t size, int index) ;
#endif /* end ifdef _INTERNAL_CHAINED_LIST */
p_chained_list get_at_chained_list (p_chained_list chained_list, void *value,
  int index) ;
p_chained_list set_at_chained_list (p_chained_list chained_list, void *value,
  size_t size, int index) ;
p_chain chain_at_chained_list (p_chained_list chained_list,
  int index) ;
void *value_at_chained_list (p_chained_list chained_list,
  int index) ;
int index_of_chained_list (p_chained_list chained_list, void *value,
  size_t size) ;
p_chain get_chained_list (p_chained_list chained_list, void *value,
  size_t size) ;
p_chained_list reverse_chained_list (p_chained_list chained_list) ;
size_t length_chained_list (p_chained_list chained_list) ;
char chained_list_reversed (p_chained_list chained_list) ;
...
p_chained_list set_chained_list_comparator (p_chained_list chained_list,
  char (*comparator) (p_chain, void *, size_t)) ;
...
p_chain new_chain_init (void *value, size_t size) ;
p_chain init_chain (p_chain chain, void *value, size_t size) ;
